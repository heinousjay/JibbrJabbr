...
public class ConfigResourceCreator extends AbstractResourceCreator<ConfigResource> {
	...
	@Override
	public ConfigResource create(Location base, String name, Object... args) throws IOException {
		return instanceModuleCreator.createResource(ConfigResource.class, resourceKey(base, name), base, name);
	}
