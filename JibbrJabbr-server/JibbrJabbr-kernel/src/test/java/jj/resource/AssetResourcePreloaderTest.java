...
public class AssetResourcePreloaderTest {
	...
	public void test() throws Exception {
		...
		verify(finder).loadResource(AssetResource.class, "jquery-2.0.3.js");
		verify(finder).loadResource(AssetResource.class, "jquery-2.0.3.min.js");
		verify(finder).loadResource(AssetResource.class, "jquery-2.0.3.min.map");
